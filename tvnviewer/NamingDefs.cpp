...
const TCHAR ProductNames::PRODUCT_NAME[] = _T("FikesMedia VNC");
const TCHAR ProductNames::VIEWER_PRODUCT_NAME[] = _T("FikesMedia VNC Viewer");
...
const TCHAR WindowNames::TVN_WINDOW_TITLE_NAME[] = _T("FikesMedia VNC Viewer");
